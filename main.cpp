...
int main() {
    ...
    const char* imagePath = "./input_image/bulldog.jpg";
    ...
    ofstream outputFile("./output_image/bulldog_random_sequence.bin", std::ios::binary);
    ...
    ofstream outputFile2("./output_image/permute_sequence.bin", std::ios::binary);
    ...
    stbi_write_jpg("./output_image/bulldog_permuted.jpg", width, height, 1, image, 100);
    ...
    stbi_write_jpg("./output_image/bulldog_unpermuted.jpg", width, height, 1, image, 100);


    /* Encryption w/ key 1*/
    cout <<" *** Encrypting image C*** " << endl;
    DNA_code(random_sequence, random_sequence_enc, img_dim, 5);
    DNA_code(image, image_enc, img_dim, 5);
    DNA_code(random_sequence2, random_sequence2_enc, img_dim, 5); //Used for key sensitivity
    ...
    stbi_write_jpg("./output_image/bulldog_encrypted.jpg", width, height, 1, encrypted_img, 100);
    ...
    ofstream outputFile3("./output_image/bulldog_random_sequence2.bin", std::ios::binary);
    ...
    DNA_code(random_sequence2, random_sequence2_enc, img_dim, 5);
    DNA_code(image, image2_enc, img_dim, 5);
    ...
    stbi_write_jpg("./output_image/bulldog_encrypted2.jpg", width, height, 1, encrypted_img2, 100);
    ...
    DNA_code(decrpyted_img_dec, decrpyted_img, img_dim, 5);
    stbi_write_jpg("./output_image/bulldog_decrypted.jpg", width, height, 1, decrpyted_img, 100);
